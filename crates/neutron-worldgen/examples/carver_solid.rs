use neutron_worldgen::carvers::{
    self, CARVE_ELLIPSOIDS, CARVE_ELLIPSOID_HIT, CARVE_ROOM_CALLS, CARVE_STARTS, CARVE_WRITES,
};
...
fn main() {
    ...
    println!(
        "origin=({},{}) side={} chunks={}",
        region.origin_x, region.origin_z, region.side, region.chunks
    );
    ...
    println!(
        "starts={} rooms={} ellipsoids={} hits={} writes={}",
    ...
    for y in WORLD_BOTTOM..320 {
        for z in 0..16 {
            for x in 0..16 {
                ...
                if matches!(b, BlockId::Air | BlockId::Lava) {
                    air += 1;
                }
            }
        }
