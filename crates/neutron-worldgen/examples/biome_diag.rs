use neutron_worldgen::{ChunkGenerator, density::DensityEnv, biome_source};
fn main() {
    ...
    for (x,z) in [(96i32, -32), (100, -27), (111, -17)] {
        ...
        println!("pos ({x},64,{z}) temp={} hum={} cont={} ero={} depth={} weird={} -> biome {}",
    ...
    for &b in &chunk.biomes { *counts.entry(b).or_insert(0u32) += 1; }
