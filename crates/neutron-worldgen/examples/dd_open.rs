...
fn main() {
  ...
  let mut dd_air=0u32; let mut dd_solid=0u32; let mut dd_air_solid_n=0u32; let mut sculk=0u32;
  for y in WORLD_BOTTOM..320 {
    for z in 0..16i32 {
      for x in 0..16i32 {
        let wx = 6*16+x; let wz = -2*16+z;
        ...
        if matches!(b, BlockId::Sculk|BlockId::SculkCatalyst) { sculk+=1; }
