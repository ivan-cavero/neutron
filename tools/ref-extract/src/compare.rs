...
//
// Compare two ref-extract JSON files and report differences.
...
/// A single chunk entry from a ref-extract JSON file.
...
/// The top-level ref-extract JSON structure.
#[derive(Debug, Deserialize)]
#[allow(dead_code)]
...
/// Compare two ref-extract files and return a report.
